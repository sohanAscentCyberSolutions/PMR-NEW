...
import com.ascent.pmrsurveyapp.databinding.ActivitySurveyReportBinding;
...
public class SurveyReport extends AppCompatActivity {
    ...
    String[] unitArray = {"KG-Acwt" , "KG-Net" , "KG-Gross" , "LBS-Net" , "LBS-Gross" , "CFT-Net"
            , "CFT-Gross"  , "CBM-Net" , "PCBM-Gross"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_survey_report);
        mActivity = this;
        ...
        binding.btSaveOffLine.setVisibility(View.GONE);
            ...
            public void onClick(View view) {
                if (checkValidation()){
                    ...
                    realm.executeTransaction(r -> {
                        ...
                        OfflineSurveyModel data = r.createObject(OfflineSurveyModel.class, uniqueId);
...
//                            runOnUiThread(() -> {
//                                startActivity(new Intent(SurveyReport.this, Dashboard.class));
...
//                        }
        ...
        binding.sagmentedGroup.setOnPositionChangedListener(new SegmentedButtonGroup.OnPositionChangedListener() {
            ...
            public void onPositionChanged(final int position) {
                ...
                if (position== 0){
                    ...
                    YoYo.with(Techniques.FadeIn)
                            .duration(600)
                            .playOn(binding.surveyInfoAdvance);
                    ...
                    YoYo.with(Techniques.FadeIn)
                            .duration(600)
                            .playOn(binding.surveyInfoArtical);
                    if (!isDetail)
                    {
                        binding.btAdd.setVisibility(View.GONE);
                        binding.btSaveOffLine.setVisibility(View.GONE);
                    ...
                    YoYo.with(Techniques.FadeIn)
                            .duration(600)
                            .playOn(binding.surveyInfoSignature);
                    if (!isDetail)
                    {
                        binding.btAdd.setVisibility(View.VISIBLE);
                        binding.btSaveOffLine.setVisibility(View.VISIBLE);
                    }
                }
            }
        });
            ...
            for (int i = 0; i < movingItemsRoad.size() ; i++) {
                ...
                if (isEmpty(etRoomName)){
                    ...
                    for (int j = 0; j < holderArtical.getChildCount() ; j++) {
                        View articleSub = holderArtical.getChildAt(j);
                        ...
                        if (isEmpty(etUnitVolume)){
                            binding.sagmentedGroup.setPosition(2,true);
                            cmn.showToast("Please Enter Article Volume");
                            return false;
                        }
    ...
    void setupListiners() {
        ...
        binding.etVolumeUnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final int[] selection = {0};

                AlertDialog.Builder alert = new AlertDialog.Builder(mActivity);
                alert.setTitle("Select Unit");
                alert.setSingleChoiceItems(unitArray, -1, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        selection[0] = which;
                        binding.etVolumeUnit.setText("" + unitArray[selection[0]]);
                        dialog.dismiss();
                    }
                });
                alert.show();
        ...
        binding.etGrossWeightUnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final int[] selection = {0};
                ...
                alert.setSingleChoiceItems(unitArray, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        selection[0] = which;
                        binding.etGrossWeightUnit.setText("" + unitArray[selection[0]]);
                        dialog.dismiss();
                    }
                });
                alert.show();
        ...
        binding.etAirChargeableWeightUnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final int[] selection = {0};
                ...
                alert.setSingleChoiceItems(unitArray, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        selection[0] = which;
                        binding.etAirChargeableWeightUnit.setText("" + unitArray[selection[0]]);
                        dialog.dismiss();
                    }
                });
                alert.show();
        ...
        binding.etSurfaceUnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final int[] selection = {0};
                ...
                alert.setSingleChoiceItems(unitArray, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        selection[0] = which;
                        binding.etSurfaceUnit.setText("" + unitArray[selection[0]]);
                        dialog.dismiss();
                    }
                });
                alert.show();
        ...
        binding.etAirUnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final int[] selection = {0};
                ...
                alert.setSingleChoiceItems(unitArray, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        selection[0] = which;
                        binding.etAirUnit.setText("" + unitArray[selection[0]]);
                        dialog.dismiss();
                    }
                });
                alert.show();
        ...
        binding.etSeaUnit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final int[] selection = {0};
                ...
                alert.setSingleChoiceItems(unitArray, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        selection[0] = which;
                        binding.etSeaUnit.setText("" + unitArray[selection[0]]);
                        dialog.dismiss();
                    }
                });
                alert.show();
        ...
        binding.etMode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < items.length ; i++) {
                    if (binding.etMode.getText().toString().toLowerCase().contains(items[i].toLowerCase())){
                        checkedItems[i] = true;
                    }else{
                        checkedItems[i] = false;
                    }
                ...
                alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (finalItems.length()>2)
                            binding.etMode.setText(finalItems.substring(0,finalItems.length()-2));
                    }
                });
                alert.show();
            }
...
//Event triggered when the pad is cleared
        ...
        binding.tvRequiredDocumentName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new FilePicker.Builder(SurveyReport.this)
                        .setLimitItemSelection(1)
                        .setAccentColor(Color.BLUE)
                        .setCancellable(true)
                        .setFileType(FileType.IMAGE)
                        .setOnSubmitClickListener(files -> {
                            requiredPetDocument =  cmn.getBase64FromPath(files.get(0).getFile().getPath());
                            binding.tvRequiredDocumentName.setText(files.get(0).getFile().getPath());
                        })
        ...
        binding.tvImageOfPet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new FilePicker.Builder(SurveyReport.this)
                        ...
                        .setFileType(FileType.IMAGE)
                        .setOnSubmitClickListener(files -> {
                            imageOfPet =  cmn.getBase64FromPath(files.get(0).getFile().getPath());
                            binding.tvImageOfPet.setText(files.get(0).getFile().getPath());
                        })
                        .setOnItemClickListener((media, pos, adapter) -> {
                            if (!media.getFile().isDirectory()) {
                                adapter.setSelected(pos);
...
*/
                    ...
                    try {
                        ...
                        for (int index = 0;index<array.length();index++){
                            standardItems.add(new StandardItemsModel(array.optJSONObject(index).optString("id")
                                    ...
                                    ,array.optJSONObject(index).optDouble("volume"),array.optJSONObject(index).optDouble("weight")));
                        }
    ...
    void addInquiryData(JSONObject object){
        if (object.optBoolean("petAvailable") == true){
            JSONObject petInfo = object.optJSONObject("petInfos");
            if (petInfo != null){
                binding.cbPet.setChecked(true);
                binding.layPet.setVisibility(View.VISIBLE);
    ...
    JSONObject getAllParams(){
        ...
        try {
            ...
            inquiryDetailsObj.put("acWeight" , replaceToNull(binding.etGrossWeight.getText().toString()));
            inquiryDetailsObj.put("acWeightUnit" ,replaceToNull(binding.etGrossWeightUnit.getText().toString()));
            inquiryDetailsObj.put("volume" , replaceToNull(binding.etVolume.getText().toString()));
            inquiryDetailsObj.put("volumeUnit" , replaceToNull(binding.etVolumeUnit.getText().toString()));
            inquiryDetailsObj.put("grossWeight" , replaceToNull(binding.etAirChargeableWeight.getText().toString()));
            inquiryDetailsObj.put("grossWeightUnit" , replaceToNull(binding.etAirChargeableWeightUnit.getText().toString()));

            inquiryDetailsObj.put("surfaceUnit" , replaceToNull(binding.etSurfaceUnit.getText().toString()));
            inquiryDetailsObj.put("seaUnit" , replaceToNull(binding.etSeaUnit.getText().toString()));
            inquiryDetailsObj.put("airUnit" , replaceToNull(binding.etAirUnit.getText().toString()));

            parameters.put("inquiry" , inquiryDetailsObj);
            parameters.put("id" , JSONObject.NULL);
            parameters.put("surveyRequest" , new JSONObject().put("id" , surveyId));
            ...
            String[] modes = binding.etMode.getText().toString().split(",");

            for (int k = 0; k < modes.length ; k++) {
                modeArray.put(modes[k]);
            }
            inquiryDetail.put("mode" , modeArray);
            ...
            if (binding.cbAnyPreviousExpinthepastYes.isChecked()){
                ...
                inquiryDetail.put("previousExp" , false);
            }
            ...
            JSONArray movingItems = new JSONArray();
            if (movingItemsSEA.size()>0){
                for (int i = 0; i < movingItemsSEA.size() ; i++) {
                    ...
                    obj.put("mode" , "SEA");
                    JSONArray areaTypes = new JSONArray();

                    JSONObject areaTypeObj = new JSONObject();
                    areaTypeObj.put("areaType" , etRoomName.getText().toString());
                    JSONArray articles = new JSONArray();

                    for (int j = 0; j <holderArtical.getChildCount() ; j++) {
                        View newView = holderArtical.getChildAt(j);
                    ...
                    areaTypeObj.put("articles", articles);
                    areaTypes.put(areaTypeObj);
                    obj.put("areaTypes" , areaTypes);
                    movingItems.put(obj);
                }
            }else{
                JSONObject obj = new JSONObject();
            ...
            inquiryDetail.put("movingItems" , movingItems);
            ...
            inquiryDetail.put("surveyType" , "BY_SURVEYOR");
   ...
   /*     JSONObject inquiry = obj.optJSONObject("inquiryDetail");
    ...
    String replaceNullToStr(String str){
        if (str == null)
            return "";
