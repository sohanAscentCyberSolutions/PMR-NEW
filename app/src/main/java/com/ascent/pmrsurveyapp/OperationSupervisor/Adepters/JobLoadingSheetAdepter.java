...
public class JobLoadingSheetAdepter extends RecyclerView.Adapter<JobLoadingSheetAdepter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView crRef, articles, loadingSequence,itemNo;
        ...
        public MyViewHolder(View view) {
            ...
            loadingSequence =view.findViewById(R.id.loadingSequence);
            articles = (TextView) view.findViewById(R.id.articles);
        }
    }


    public JobLoadingSheetAdepter(Activity ctx , ArrayList<PackingItemModel> dataList , ClickAdepterListener onClickListener) {
    ...
    @Override
    public JobLoadingSheetAdepter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_loading_list, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.loadingSequence.setText(""+model.loadingSequence);
