...
public class UploadDocumentsJob extends AppCompatActivity {


    Comman cmn;
    Activity mActivity;
    ActivityUploadDocumentsJobBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_upload_documents_job);
    ...
    void SaveData(){
        ...
        try {
            ...
            parameters.put("jobExecution" , new JSONObject().put("id" , jobId));
JSONArray documents = new JSONArray();
        ...
        String url = "jobexecution?Operation=UploadDocument";
